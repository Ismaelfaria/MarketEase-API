        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    PackagingTypesId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_products_packaging_PackagingTypesId",
                        column: x => x.PackagingTypesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_products_PackagingTypesId",
                table: "products",
                column: "PackagingTypesId");
        }
